...
@section ("title", "Upload Dokumen Persyaratan - PPDB SD Negeri Legok III")
                ...
                @if (!$pendaftaran)
                    ...
                    >
                        ...
                        <p style="
                                ...
                                color: var(--text-dark);
                                margin: 0 0 8px;
                            ">Formulir Pendaftaran Belum Diisi</p>
                ...
                @else
                    ...
                    <div class="dok-two-col">
                            ...
                            <div class="section-card">
                                ...
                                >
                                    ...
                                    <div class="dok-form-group">
                                        ...
                                        >
                                            Jenis Dokumen
                                            <span class="dok-required">*</span>
                                        </label>
                                        <div class="dok-select-wrap">
                                            <select
                                                name="jenis_dokumen"
                                                id="jenis_dokumen"
                                                class="dok-select @error('jenis_dokumen') is-invalid @enderror"
                                                required
                                            >
                                                <option
                                                    value=""
                                                ...
                                                <option
                                                    ...
                                                    {{
                                                        old("jenis_dokumen") == "kartu_keluarga"
                                                            ? "selected"
                                                            : ""
                                                    }}
                                                    >Kartu Keluarga (KK)
                                                ...
                                                <option
                                                    ...
                                                    {{
                                                        old("jenis_dokumen") == "akta_kelahiran"
                                                            ? "selected"
                                                            : ""
                                                    }}
                                                    >Akta Kelahiran
                                                ...
                                                <option
                                                    value="ktp_orang_tua"
                                                    {{
                                                        old("jenis_dokumen") == "ktp_orang_tua"
                                                            ? "selected"
                                                            : ""
                                                    }}
                                                    >KTP Orang Tua / Wali
                                            ...
                                            <i
                                                class="fas fa-chevron-down dok-select-arrow"
                                            ></i>
                                        </div>
                                        @error ("jenis_dokumen")
                                            <span class="dok-field-error"
                                                ><i
                                    ...
                                    <div class="dok-dropzone" id="dropZone">
                                        <input
                                            ...
                                            name="file"
                                            id="fileInput"
                                            class="dok-dropzone-input"
                                            accept=".jpg,.jpeg,.png,.pdf"
                                            required
                                        />
                                        <div
                                            id="dropZoneContent"
                                            class="dok-dropzone-body"
                                        >
                                            <div class="dok-dropzone-icon">
                                                <i
                        ...
                        <div class="dok-col-right">
                            <div class="section-card">
                                <h2 class="section-title">
                                    <i class="fas fa-clipboard-list"></i> Syarat
                                    Dokumen
                                </h2>
                                ...
                                <div class="dok-syarat-list">
                                    @foreach ($syarat as $s)
                                        ...
                                        <div
                                            class="dok-syarat-item {{ $st === 'valid' ? 'is-valid' : ($st ? 'is-uploaded' : '') }}"
                                        >
                                            <div
                                                class="dok-syarat-icon"
                                            ...
                                            <div class="dok-syarat-info">
                                                <span
                                                    class="dok-syarat-name"
                                                    >{{ $s["label"] }}</span
                                                >
                                                <span class="dok-syarat-sub"
                                                    >JPG, PNG, PDF Maks.
                                                    5MB</span
                                                >
                                            </div>
                                            <div class="dok-syarat-status">
                                                @if ($st === "valid")
                                                    <span
                                                        class="dok-badge dok-badge-valid"
                                                        ><i
                                                            class="fas fa-check"
                                                        ></i>
                                                        Valid</span
                                                ...
                                                @elseif ($st === "pending")
                                                    <span
                                                        class="dok-badge dok-badge-pending"
                                                        ><i
                                                            class="fas fa-clock"
                                                        ></i>
                                                        Menunggu</span
                                                ...
                                                @elseif ($st === "tidak_valid")
                                                    <span
                                                        class="dok-badge dok-badge-invalid"
                                                        ><i
                                                            class="fas fa-times"
                                                        ></i>
                                                        Ditolak</span
                                                ...
                                                @else
                                                    <span
                                                        class="dok-badge dok-badge-empty"
                                                    >
                                                        Belum</span
                                                    >
                                                @endif
                                ...
                                <div class="dok-progress-wrap">
                                    <div class="dok-progress-bar">
                                        <div
                                            class="dok-progress-fill"
                                            style="width:{{ $total > 0 ? ($done/$total)*100 : 0 }}%"
                                        ></div>
                                    </div>
                                    <span class="dok-progress-label"
                                        >{{ $done }}/{{ $total }}</span
                                    >
                                </div>
                            </div>
                            ...
                            <div class="dok-list">
                                @foreach ($dokumen as $item)
                                    <div class="dok-list-item">
                                        <div
                                            class="dok-list-icon {{ $item->ekstensi === 'pdf' ? 'dok-icon-red' : 'dok-icon-blue' }}"
                                        >
                                            <i
                                                class="fas {{ $item->ekstensi === 'pdf' ? 'fa-file-pdf' : 'fa-file-image' }}"
                                            ></i>
                                        </div>
                                        <div class="dok-list-info">
                                            <span
                                                class="dok-list-jenis"
                                                >{{ $item->jenis_label }}</span
                                            >
                                            <span
                                                class="dok-list-fname"
                                                >{{ $item->nama_asli }}</span
                                            >
                                        ...
                                        <div class="dok-list-actions">
                                            <a
                                                ...
                                                target="_blank"
                                                class="dok-action-btn dok-action-view"
                                                title="Lihat"
                                            >
                                            ...
                                            <a
                                                href="{{ asset($item->file_path) }}"
                                                download
                                                class="dok-action-btn dok-action-download"
                                                title="Unduh"
                                            >
                                            ...
                                            @if ($item->status_verifikasi !== "valid")
                                                <form
                                                    action="{{ route('dokumen.destroy', $item->id_dokumen) }}"
                                                    method="POST"
                                                    onsubmit="
                                                        return confirm(
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        type="submit"
                                                        class="dok-action-btn dok-action-delete"
                                                        title="Hapus"
                                                    >
                                                        <i
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function showPreview(file) {
                ...
                previewIcon.className =
                    "dok-prev-icon" + (isPdf ? " pdf" : isImg ? " image" : "");
